							...
							<tbody>
								<tr v-for="(data, index) in datas" :key="index">
									...
									<td class="text-left">
										...
										<j-button type="edit" :action="true" @click="$bus.emit('update.show', data)" v-if="data.code === 'CUSTOM'"></j-button>
										<j-button type="delete" :action="true" @click="doDelete(data.id)" v-if="data.code === 'CUSTOM'"></j-button>
									</td>
								</tr>
							</tbody>
						</table>
